<div class="sidebar">
    ...
    <?php if($user): ?>
        <div class="user-info">
            ...
            <img class="toggle-menu" src="<?= asset('img/icons/menu.svg') ?>" alt="Toggle Menu">
        </div>
    <?php else: ?>
    ...
    <div class="form">
        <form action="<?= base_url('/search') ?>" method="POST">
            <div class="form-group search">
                <input type="text" name="s" placeholder="Search" value="<?= $keywords ?? '' ?>">
            </div>
        </form>
    </div>
    ...
    <?php if(isset($category_data)): ?>
        <div class="category-info">
            ...
            <?php if($user): ?>
                <?php if(!$this->userModel->userFollows($user->user_id, $category_data->category_id)): ?>
    ...
    <div class="nav-buttons">
        <a href="<?= base_url('/top') ?>"><button>Top Posts</button></a>
        <a href="<?= base_url('/new') ?>"><button>New Posts</button></a>
    </div>
