    ...
    <div class="post">
        <span class="vote">
            <?php if(isset($user)): ?>
                ...
                <?php else: ?>
                    <a href="<?= base_url('/unvote') ?>/<?= $post_data->post_id ?>"><img src="<?= asset('img/icons/unvote.svg') ?>" alt="Unvote"></a>
                <?php endif; ?>
            <?php else: ?>
        ...
        <h5>
            ...
            <?php endif; ?>
            on
            <?= format_date($post_data->post_date) ?>
            in
        ...
        <?php foreach($comments as $comment): ?>
            <div class="post">
                <h5>
                    ...
                    <?php endif; ?>
                    on
                    <?= format_date($comment->comment_date) ?>
                </h5>
