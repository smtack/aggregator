          ...
          <span class="vote">
            <?php if($user): ?>
              <?php if(!$this->postModel->hasVoted($user->user_id, $post_result->post_id)): ?>
                <a href="<?= base_url('/vote') ?>/<?= $post_result->post_id ?>"><img src="/assets/img/icons/vote.svg" alt="Vote"></a>
              <?php else: ?>
                <a href="<?= base_url('/unvote') ?>/<?= $post_result->post_id ?>"><img src="/assets/img/icons/unvote.svg" alt="Unvote"></a>
              <?php endif; ?>
            <?php else: ?>
