...
class CategoryController extends Controller
{
    ...
    public function category(int $id)
    {
        ...
        $posts = $this->postModel->getPostsByCategory($id, $pagination->offset(), $pagination->limit());
    ...
    public function categories()
    {
        ...
        $categories_list = $this->categoryModel->getCategories($pagination->offset(), $pagination->limit());
        
        $pagination->setTotal($categories_list['total']);
